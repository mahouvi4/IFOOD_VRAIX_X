...
$lik = listeclientboutiqo($_GET['representantboutique']);
echo $_GET['representantboutique'];
  ...
  <table>
   ...
   <td> <?php 
        if($produits->statut==1){
            echo "<span class='lil'><a href='bout.php?statut=$produits->statut&&idclient=$produits->idclient'>Legible</a></span>";
