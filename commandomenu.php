...
$varaffichercommande=affichcomcli($_GET['idclient']);
  ...
  <table>
    <thead>
      ...
      <th>Code</th>
        ...
        <th><span class="action_btn"><a href="menuvertical.php">HOME</a></span></th>
    ...
    <tfoot>
                  <tr>
                   ...
                   <tr>
                       <td>
                           <a href="../fpdf/ETATSS.php?idclient=<?=$_GET['idclient']?>">Telecharger reçue</a>
                       </td>
                   </tr>
              </tfoot>
