...
move_uploaded_file($imageproduit,"../images/".$photo);
 ...
 if(controlemail($emailsuser)==true){
        echo "<div class='alert-danger'>DESOLE UN COMPTE EXISTE DEJA AVEC CET EMAIL!! <a href='reinitialisation.php?emails=$emailsuser'>Mot de Passe Oublié?</a></div>";
        return;
    }else{
        creercompteuser($nomclient,$prenomclient,$sexclient,$cpfclient,$telephoneclient,$emailsuser,$motdepass,$photo);
    echo "message enregistré aevc suces!!";
    }
    header("location:connectcli2.php?");
...
.cox{
  ...
  .vio{
    ...
    <div class="row100">
                 <div class="col">
                     <div class="inputBox">
                         <input type="file" name="nix" class="cox" required="required">
                     </div>
                 </div>
                 ...
                 <div class="col">
                     <div class="inputBox">
                         <input type="email" name="d" required="required">
                 ...
                 <div class="col">
                     <div class="inputBox">
                         <input type="password" name="e" required="required">
             ...
             <div class="row100">
                 <div class="col">
                     <div class="inputBox">
                         <input type="text" name="g" required="required">
                 ...
                 <div class="col">
                     <div class="inputBox">
                         <input type="text" name="h" required="required">
