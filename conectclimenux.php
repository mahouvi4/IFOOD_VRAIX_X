...
if($reponse=$y->fetch(PDO::FETCH_OBJ)){
      ...
      if($reponse->status==0){
        ...
        <a href='cadastro2.php'>VEILLEZ CONTACTER L'ADMINISTRATEUR </a></strong></div>";
      }else{
        ...
        $idclient=$_SESSION['stockinfoclients']->idclient;
          ...
          if($flox=$adresse->fetch(PDO::FETCH_OBJ)){
            ...
            header("location:infouser.php?idclient=$flox->idclient");
    ...
    <a href='cadastro2'>OUVRIR UN COMPTE? </a>OU </strong></div>";
}
...
@media (max-width:768px) and (orientation: landscape) {
 ...
 .container div a{
    ...
    <form method="POST">
             ...
             <div><a href='cadastro2.php'>Ouvrir un Compte?</a></div>
