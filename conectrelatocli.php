...
if($reponse=$y->fetch(PDO::FETCH_OBJ)){
      ...
      if($reponse->statut==0){
        ...
        <a href='cadastro.php'>VEILLEZ CONTACTER L'ADMINISTRATEUR </a></strong></div>";
      }else{
        ...
        $idclient=$_SESSION['stockinfoclients']->idclient;
          ...
          if($flox=$adresse->fetch(PDO::FETCH_OBJ)){
            ...
            header("location:relatocomando.php?idclient=$flox->idclient");
    ...
    <a href='cadastro'>OUVRIR UN COMPTE? </a>OU </strong></div>";
}
...
@media (max-width:768px) and (orientation: landscape) {
 ...
 .container div a{
    ...
    <form method="POST">
             ...
             <div><a href='cadastro.php'>Ouvrir un Compte?</a></div>
