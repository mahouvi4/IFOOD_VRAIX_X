    ...
    <body>
         ...
         <section>
             <div class="container">
                 ...
                 <div class="col">
                     <div class="inputBox">
                         <input type="text" name="ender" class="gog"  required="required">
                         <span class="text">Adresse Boutique</span>
                 ...
                 <div class="col">
                     <div class="inputBox">
                         <input type="text" name="lato" class="gog"  required="required">
                 ...
                 <div class="col">
                     <div class="inputBox">
                         <input type="text" name="longo" class="gog"  required="required">
