...
if (isset($_POST['f'])) {
    ...
    $y=pageconnexionboutique($emailuser,$motdepasseuser);

    if ($reponse=$y->fetch(PDO::FETCH_OBJ)){
        if ($reponse->statut==0){
            echo "<div class='alert-danger'><strong>DESOLE VOTRE COMPTE E DESACTIVE! ,
        <a href='cadastrobout'>VEILLEZ CONTACTER L'ADMINISTRATEUR </a>OU </strong></div>";
        }else{
            $_SESSION['boutique']=$reponse;
          ...
          if($flox=$adresse->fetch(PDO::FETCH_OBJ)){
            ...
            header('location:addbout.php');
        }
    }
  }else{
  echo "<div class='alert-danger'><strong>DESOLE MOT DE PASSE OU EMAIL ERRONE,
  <a href='cadastrobout'>OUVRIR UN COMPTE? </a>OU </strong></div>";
}

} 
   /*else if {
        echo "<div class='alert-danger'><strong>DESOLE MOT DE PASSE OU EMAIL ERRONE,
    <a href='reinitialisermotdepasse.php'>OUVRIR UN COMPTE? </a>OU </strong></div>";
    }
} 
 
  if (!empty($_POST['a'])) {
      echo "<a href='reinitialiser.php? emailss=$emailuser'> mot de passe oublié?</a>";
  }*/
...
@media (max-width:768px) and (orientation: landscape) {
    ...
    <form method="POST">
             ...
             <div class="row100">
                 <div class="col">
                     <div class="inputBox">
                         <input type="email" name="a" class="form-control" required="required">
                 ...
                 <div class="col">
                     <div class="inputBox">
                         <input type="password" name="d" class="form-control" required="required">
