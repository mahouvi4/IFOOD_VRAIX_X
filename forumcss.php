...
session_start();
 ...
 if(isset($_SESSION['stockinfoclients']) && !empty($_SESSION['stockinfoclients'])){
    ...
    $profileclient=$_SESSION['stockinfoclients']->profileclient;
    $nomclient=$_SESSION['stockinfoclients']->nomclient;
    $prrenomclient=$_SESSION['stockinfoclients']->prenomclient;
 ...
 if(isset($_POST['btn'])){
    if(isset($_SESSION['stockinfoclients']) && !empty($_SESSION['stockinfoclients'])){
       ...
       $titreforum=$_POST['titreforum'];
        $motiveforum=$_POST['motiveforum'];
        
        insertionforum($titreforum ,$motiveforum ,$idclient);
      ...
      header('refresh:3,url=connectcliforum.php?p=VEILLEZ VOUS CONNECTEZ VOTRE COMPTE');
...
::-webkit-scrollbar{
    ...
    <form method="POST" enctype="multipart/form-data">
                 ...
                 <div class="col">
                     <div class="inputBox">
                         <input type="text" type="text" name="titreforum" class="gog" required="required">
                         <span class="text">Objeto</span>
                 ...
                 <div class="col">
                   <div class="inputBox textarea">
                       <textarea  name="motiveforum" rows="8px" class="ibi" required="required"></textarea>
                       <span class="text">Motivo</span>
                         <span class="line"></span>
                   </div>
               </div>
               </div>
