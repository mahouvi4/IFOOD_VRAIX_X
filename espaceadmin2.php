...
<html>
    ...
    min-height: 100vh;
    background: linear-gradient(315deg,#03a9f4, #000000, #fff);            
    ...
    .row {
     ...
     <a href="listoprod.php">
      ...
      <div class="card I">
         ...
         <div class="row jik">
         <a onclick="return confirm('Voulez vous y retourner Vraiment a la Page1?')" href='espaceadmin.php'>
                            <button type="submit" class="blouta" >
                         <span class="glyphicon glyphicon-save">RETOUR-PAGE1</span>
                          </button>
                            </a>
         </div>
      </div>
