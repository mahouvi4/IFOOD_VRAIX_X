...
header("location:listeboutpro.php?emails=$emailsss");
...
@media (max-width:768px) and (orientation: landscape) {
    ...
    <form method="POST">
             ...
             <div class="row100">
                 <div class="col">
                     <div class="inputBox">
                         <input type="email" name="a" class="form-control" value="<?=$emailsss?>" required="required">
                 ...
                 <div class="col">
                     <div class="inputBox">
                         <input type="password" name="d" class="form-control" value="<?=$senha?>" required="required">
