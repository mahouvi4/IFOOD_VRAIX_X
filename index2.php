...
include_once './connexionbase2.php';
...
::-webkit-scrollbar{
    ...
    <section>
        ...
        if (!empty($data['SendAddMsg'])) {
            ...
            $query_msg="INSERT INTO clipublicat(name, email, subject, content, created, idclient)VALUES(?,?,?,?,NOW(),?)";
            ...
            $add_msg->bindParam(':idclient', $data['idclient'], PDO::PARAM_STR);
            $add_msg->execute();
