...
$tol=afficheradresse($_GET['idclient']);
$bota=$tol->fetch();
$etats=$bota['etats'];
$villes=$bota['ville'];
$quartiers=$bota['quartier'];
$rues=$bota['rue'];
$numeros=$bota['numeros'];
$cep=$bota['cep'];
...
if(isset($_POST['boto'])){
    ...
    echo $etats=$_POST['etat'];
    echo $villes=$_POST['ville'];
    echo $quartiers=$_POST['quartier'];
    echo $rues=$_POST['rue'];
    echo $numeros=$_POST['numeros'];
    echo $cep=$_POST['cep'];
    modifieradresscli($etats,$villes,$quartiers,$rues,$numeros,$cep,$_GET['idclient']);
    echo "adresse modifieé avec sucess!!";
...
.cox{
  ...
  .vio{
   ...
   <div class="row100">
                 <div class="col">
                     <div class="inputBox">
                         <input type="text" class="form-control" name="etat" value="<?=$etats?>" required="required">
                 ...
                 <div class="col">
                     <div class="inputBox">
                         <input type="text" class="form-control" name="ville" value="<?=$villes?>" required="required">
             ...
             <div class="row100">
                 <div class="col">
                     <div class="inputBox">
                         <input type="text" class="form-control" name="quartier" value="<?=$quartiers?>" required="required">
                 ...
                 <div class="col">
                     <div class="inputBox">
                         <input type="text" class="form-control" name="rue" value="<?=$rues?>"required="required">
             ...
             <div class="row100">
                 <div class="col">
                     <div class="inputBox">
                         <input type="number" class="form-control" name="numeros" value="<?=$numeros?>" required="required">
                 ...
                 <div class="col">
                     <div class="inputBox">
                         <input type="text" class="form-control" name="cep" value="<?=$cep?>" required="required">
             ...
             <a href="menuvertical.php">SORTIR</a>
         </section>
